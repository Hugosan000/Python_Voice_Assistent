...
__all__ = [
    'DISPID_SLPPhoneIds', 'SAFT32kHz16BitStereo',
    'DISPID_SpeechRecognizer', 'DISPID_SVGetAudioOutputs',
    'DISPID_SLGenerationId', 'DISPID_SRSCurrentStreamNumber',
    'SWPKnownWordPronounceable', 'DISPID_SPRules_NewEnum',
    'SPAR_Medium', 'SPFM_NUM_MODES', 'SPPHRASERULE', 'SAFTDefault',
    'SPEI_ADAPTATION', 'DISPID_SRProfile', 'DISPID_SGRSTs_NewEnum',
    'SLTUser', 'SPINTERFERENCE_LATENCY_WARNING', 'SPSLMA',
    'DISPIDSPRG', 'SAFT11kHz8BitStereo', 'SECFIgnoreWidth',
    'SDA_Consume_Leading_Spaces', 'SP_VISEME_18',
    'DISPID_SRCESoundStart', 'SRESoundEnd', '_SPAUDIOSTATE',
    'SpeechStreamFileMode', 'SPPS_RESERVED1', 'DISPID_SAEventHandle',
    'SPEI_VOICE_CHANGE', 'ISpeechGrammarRuleState', 'SLODynamic',
    'ISpeechRecoResultDispatch', 'DISPID_SPCIdToPhone',
    'STCRemoteServer', 'DISPID_SPEAudioSizeTime', 'SBONone',
    'DISPID_SGRsAdd', 'eLEXTYPE_RESERVED4', 'SP_VISEME_2',
    'SDKLDefaultLocation', 'eWORDTYPE_DELETED',
    'SRSInactiveWithPurge', 'SPEI_SR_PRIVATE',
    'DISPID_SPEAudioTimeOffset', 'ISpeechRecoResultTimes',
    'ISpeechPhraseElements', 'ISpeechPhraseInfo', 'SPWORDTYPE',
    'SPEI_RESERVED5', 'SVEEndInputStream',
    'SpeechDictationTopicSpelling', 'SASRun', 'DISPID_SGRSTType',
    'ISpeechVoiceStatus', 'DISPID_SRCCreateGrammar',
    'SPFM_OPEN_READWRITE', 'SAFT22kHz8BitMono',
    'DISPID_SRCERequestUI', 'SASStop', 'SP_VISEME_13',
    'DISPID_SPPs_NewEnum', 'SITooSlow',
    'DISPID_SpeechGrammarRuleStateTransition', 'SREPrivate',
    'ISpeechCustomStream', 'DISPID_SOTRemoveStorageFileName',
    'SVEPhoneme', 'SpeechPropertyAdaptationOn', 'DISPID_SRCEBookmark',
    'SPWAVEFORMATTYPE', 'DISPID_SBSFormat', 'DISPID_SPPParent',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPCT_DICTATION',
    'DISPID_SVEBookmark', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRRTOffsetFromStart', 'SPSTREAMFORMATTYPE',
    'tagSPPROPERTYINFO', 'SAFT12kHz16BitMono', 'SREInterference',
    'Speech_Max_Word_Length', 'DISPID_SOTGetAttribute',
    'SpeechAllElements', 'DISPID_SASCurrentDevicePosition',
    'SPAS_STOP', 'SPLOADOPTIONS', 'DISPID_SPERetainedSizeBytes',
    'eLEXTYPE_PRIVATE13', 'SpeechEngineProperties', 'DISPID_SGRsItem',
    'ISpeechGrammarRule', 'DISPID_SOTCGetDataKey',
    'DISPID_SPPFirstElement', 'SPPROPERTYINFO',
    'DISPID_SPIEnginePrivateData',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SRATopLevel',
    'DISPID_SPRs_NewEnum', 'DISPID_SDKGetStringValue',
    'DISPID_SRCESoundEnd', 'SSFMCreate', 'DISPID_SRGetFormat',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SpeechRecognizerStatus',
    'UINT_PTR', 'SPCATEGORYTYPE', 'SGDSActiveUserDelimited',
    'DISPID_SRCVoice', 'SECNormalConfidence',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SAFSetWaveFormatEx',
    'SPEI_TTS_AUDIO_LEVEL', 'STSF_AppData', 'SpInProcRecoContext',
    'ISpLexicon', 'SPRECOCONTEXTSTATUS', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechVoice', 'SVP_11', 'SGRSTTWord', 'SAFT48kHz8BitMono',
    'ISpeechGrammarRuleStateTransitions', 'SAFT12kHz8BitMono',
    'SAFTCCITT_ALaw_22kHzMono', 'SDTRule', 'SPSEMANTICERRORINFO',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SVEStreamStart',
    'SpeechCategoryPhoneConverters',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFT8kHz16BitStereo',
    'SPLEXICONTYPE', 'SPPHRASEELEMENT',
    'SpeechRegistryLocalMachineRoot', 'ISpeechAudioBufferInfo',
    'SVP_2', 'SVPNormal', 'DISPID_SpeechPhraseBuilder',
    'SPPS_Interjection', 'SPFM_CREATE_ALWAYS', 'DISPID_SRRSpeakAudio',
    'SVF_None', 'DISPID_SRCPause', 'DISPID_SPRsCount',
    'DISPID_SpeechMemoryStream', 'SPEI_MIN_TTS',
    'DISPID_SRCreateRecoContext', 'SPRECORESULTTIMES',
    'DISPID_SRCEPropertyNumberChange', 'SpShortcut',
    'DISPID_SRGetPropertyString',
    'DISPID_SPANumberOfElementsInResult', 'SpVoice', 'SPAO_NONE',
    'SpUnCompressedLexicon', 'DISPID_SPRFirstElement', 'SPCT_COMMAND',
    'DISPID_SOTCreateInstance', 'DISPID_SOTDisplayUI',
    'DISPID_SGRName', 'SpObjectToken', 'DISPID_SASState',
    'SPPS_RESERVED2', 'ISpeechDataKey', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVSInputSentencePosition', 'SVSFPersistXML',
    'DISPID_SpeechLexiconProns', 'DISPID_SVEVoiceChange',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEI_RESERVED3',
    '__MIDL_IWinTypes_0009', 'eLEXTYPE_RESERVED8',
    'eLEXTYPE_USER_SHORTCUT', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPDKL_LocalMachine', 'SVEBookmark', 'DISPID_SpeechBaseStream',
    'SPINTERFERENCE_NOSIGNAL', 'SPINTERFERENCE_NONE',
    'ISpeechMemoryStream', 'ISpRecognizer3', 'DISPID_SRRAudioFormat',
    'SpeechAddRemoveWord', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SVEStreamEnd', 'DISPID_SpeechPhraseInfo',
    'SpeechCategoryAudioOut', 'SVSFIsXML',
    'DISPID_SRCAudioInInterferenceStatus',
    'SpeechRetainedAudioOptions', 'DISPIDSPTSI_ActiveOffset',
    'ISpeechAudioFormat', 'eLEXTYPE_PRIVATE9', 'SRAImport',
    'DISPID_SPIStartTime', 'DISPID_SPPId', 'SECFNoSpecialChars',
    'SPPS_Modifier', 'SPWORD', 'DISPID_SVSRunningState',
    'DISPID_SPAs_NewEnum', 'DISPID_SpeechVoiceStatus',
    'ISpeechPhraseRule', 'DISPID_SGRSAddWordTransition',
    'SPGRAMMARWORDTYPE', 'eLEXTYPE_PRIVATE10', 'SpWaveFormatEx',
    'SpeechTokenIdUserLexicon', 'DISPID_SRCEStartStream',
    'SpMMAudioIn', 'SpeechCategoryRecoProfiles', 'WAVEFORMATEX',
    'SINoise', 'Speech_Default_Weight', 'ISpeechAudio', 'SP_VISEME_8',
    'DISPID_SRCRequestedUIType',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEVENTSOURCEINFO', 'DISPID_SPIRule', 'DISPID_SRRAudio',
    'SpeechDisplayAttributes', 'DISPID_SPPValue', 'ISpGrammarBuilder',
    'DISPID_SVResume', 'DISPID_SLPs_NewEnum',
    'SpeechGrammarRuleStateTransitionType', 'ISpRecognizer2',
    'SITooFast', 'SREPropertyNumChange', 'SPCT_SUB_DICTATION',
    'DISPID_SpeechCustomStream', 'SPWORDPRONUNCIATION',
    'DISPID_SWFEBlockAlign', 'DISPID_SVRate', 'ISpeechVoice',
    'DISPID_SBSWrite', 'SAFT12kHz8BitStereo',
    'ISpeechPhraseAlternate', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechGrammarRuleState', 'SpeechGrammarWordType',
    'SSSPTRelativeToStart', 'DISPID_SVSkip', 'DISPID_SRStatus',
    'ISpPhoneConverter', 'DISPID_SVSInputWordPosition',
    'DISPID_SLWPronunciations', 'SAFT16kHz16BitMono', 'SVP_1',
    'SAFTCCITT_uLaw_8kHzStereo', 'SRSActiveAlways', 'SRAONone',
    'SVP_21', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPEI_REQUEST_UI',
    'SVP_16', 'DISPID_SpeechPhraseAlternate', 'SINone',
    'ISpeechLexicon', 'STCLocalServer', 'DISPID_SpeechGrammarRules',
    'SECFEmulateResult', 'SFTInput', 'eLEXTYPE_PRIVATE19',
    'DISPID_SABIBufferSize', 'SRTAutopause',
    'SpeechGrammarTagWildcard', 'DISPID_SPCPhoneToId',
    'DISPID_SPACommit', 'tagSPTEXTSELECTIONINFO', 'DISPID_SRIsShared',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRCEHypothesis', 'ISpeechPhraseElement', 'SPPARTOFSPEECH',
    'SAFTADPCM_11kHzStereo', 'SAFTADPCM_44kHzMono',
    'SAFTCCITT_ALaw_22kHzStereo', 'SSFMCreateForWrite',
    'DISPID_SpeechPhraseRule', 'SpCustomStream', 'SVP_19',
    'DISPID_SRRTTickCount', 'SVP_7', 'SAFTNoAssignedFormat',
    'DISPID_SWFEBitsPerSample', 'SPSUnknown', 'DISPID_SLWType',
    'DISPID_SRGReset', 'ISpeechLexiconWord', 'SpeechAudioVolume',
    'SRCS_Enabled', 'SpNullPhoneConverter',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRCEAdaptation', 'DISPID_SVSLastBookmarkId',
    'ISpStreamFormatConverter', 'DISPID_SpeechAudioStatus',
    'IInternetSecurityManager', 'DISPID_SMSGetData',
    'SRADefaultToActive', 'DISPID_SRRTStreamTime',
    'SpeechMicTraining', 'SPEI_END_SR_STREAM', 'SPEI_VISEME',
    'DISPID_SABufferNotifySize', 'SVSFParseSapi', 'SPEI_MAX_TTS',
    'Speech_StreamPos_RealTime', 'SDTProperty',
    'DISPID_SGRsCommitAndSave', 'SVSFUnusedFlags', 'SPRS_INACTIVE',
    'ISpNotifyTranslator', 'DISPID_SOTCategory', 'SPEVENTENUM',
    'SREAdaptation', 'eLEXTYPE_PRIVATE18',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SpeechMMSysAudio',
    'DISPID_SLWWord', 'DISPID_SPIAudioStreamPosition', 'SPCS_ENABLED',
    'SPRST_INACTIVE_WITH_PURGE', 'eLEXTYPE_RESERVED7',
    'DISPID_SAFGuid', 'SpeechStreamSeekPositionType',
    'SAFTADPCM_11kHzMono', 'SpeechEngineConfidence',
    'SPEI_FALSE_RECOGNITION', 'eLEXTYPE_PRIVATE14', 'SVP_18',
    'DISPID_SCSBaseStream', 'SPSModifier', 'DISPID_SPELexicalForm',
    'SPEI_HYPOTHESIS', 'ISpeechGrammarRules', 'SPLO_DYNAMIC', 'SVP_8',
    'ISpVoice', 'SVP_4', 'DISPID_SRSClsidEngine',
    'DISPID_SASNonBlockingIO', 'DISPID_SABIEventBias',
    'SPWT_PRONUNCIATION', 'SPPS_Verb', 'DISPID_SRRGetXMLResult',
    'SpAudioFormat', 'DISPID_SGRSTPropertyName', 'SP_VISEME_10',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpObjectTokenCategory', 'SRSEDone',
    'DISPID_SVEventInterests', 'SPRULESTATE', 'SPXRO_Alternates_SML',
    'DISPID_SVEWord', 'DISPID_SDKGetlongValue', 'SITooLoud',
    'SpLexicon', 'eLEXTYPE_PRIVATE5', 'DISPID_SBSRead',
    'DISPID_SRRTimes', 'SpeechGrammarTagDictation',
    'SPEI_SR_BOOKMARK', 'SVP_17', 'STCInprocHandler',
    'SPEI_INTERFERENCE', 'SRCS_Disabled', 'SpPhoneConverter',
    'DISPID_SLRemovePronunciation', 'SVEStartInputStream',
    'DISPID_SGRSAddSpecialTransition', 'SPRECOSTATE',
    'DISPID_SVEAudioLevel', 'SVESentenceBoundary',
    'DISPID_SRDisplayUI', 'SPWORDPRONOUNCEABLE',
    'SpeechVoicePriority', 'SpeechPropertyHighConfidenceThreshold',
    'SpeechPropertyLowConfidenceThreshold', 'SpeechRuleAttributes',
    ...
    'SVEAudioLevel', 'SDTAll', 'tagSTATSTG',
    'DISPID_SPEPronunciation', 'SPBO_AHEAD', 'SP_VISEME_11',
    'SREPhraseStart', 'DISPID_SRRDiscardResultInfo',
    'ISpeechTextSelectionInformation', 'DISPID_SVEPhoneme',
    'DISPID_SRSetPropertyNumber', 'DISPID_SLWLangId', 'SVP_0',
    'SPRULE', 'SAFTADPCM_44kHzStereo', 'SDKLCurrentConfig',
    'ISpeechPhraseRules', 'DISPID_SRCRetainedAudioFormat',
    'SPSHT_Unknown', 'ISpeechRecoResult', 'DISPID_SRRTLength',
    'SVEPrivate', 'ISpeechPhraseInfoBuilder', 'SPPS_SuppressWord',
    'DISPID_SAStatus', 'ISpRecoResult', 'DISPID_SGRId',
    'DISPID_SRSCurrentStreamPosition', 'ISpRecoGrammar2',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SABufferInfo',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SLPsItem',
    'SGRSTTRule', 'SPEI_START_INPUT_STREAM', 'SPADAPTATIONRELEVANCE',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SpeechDataKey',
    'DISPID_SOTs_NewEnum', 'DISPID_SRGRules', 'DISPID_SPPsItem',
    'SpeechBookmarkOptions', 'SGRSTTEpsilon', 'SpeechDiscardType',
    'SAFTADPCM_22kHzMono', 'ISpeechPhraseReplacements',
    'DISPID_SRGCmdSetRuleState', 'SpeechWordType',
    'DISPID_SPRDisplayAttributes', 'ISpSerializeState',
    'ISpeechPhraseAlternates', 'DISPID_SpeechPhraseElements',
    'SPSNotOverriden', 'eLEXTYPE_PRIVATE2', 'SVSFParseAutodetect',
    'SAFTGSM610_8kHzMono', 'ISpeechLexiconPronunciation',
    'SPBO_PAUSE', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SDA_Two_Trailing_Spaces', 'SVPOver', 'DISPID_SGRAddResource',
    'ISpeechPhraseReplacement', 'DISPID_SWFESamplesPerSec',
    'SGLexical', 'SpSharedRecoContext', 'SpResourceManager',
    'SpeechDataKeyLocation', 'SECLowConfidence',
    'DISPID_SRGSetWordSequenceData', 'SECHighConfidence',
    'SpeechEmulationCompareFlags', 'eLEXTYPE_USER',
    'SpObjectTokenCategory', 'SPEI_RECOGNITION',
    'DISPID_SPIRetainedSizeBytes', 'SAFT11kHz16BitStereo',
    'SpeechTokenContext', 'SREAudioLevel', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT11kHz8BitMono', 'SAFT44kHz8BitMono',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFT24kHz8BitMono', 'ISpObjectToken',
    'SVP_20', 'DISPID_SRGCmdLoadFromMemory', 'DISPID_SOTsCount',
    'DISPID_SVPause', 'ISpeechWaveFormatEx',
    'DISPID_SRGDictationLoad', 'SpInprocRecognizer', 'SPSMF_UPS',
    'SpeechVoiceEvents', 'SAFT22kHz16BitMono', 'SVP_14',
    'SpeechRegistryUserRoot', 'SGSDisabled', 'DISPID_SAVolume',
    'SpeechPartOfSpeech', 'SVPAlert', 'SpeechPropertyResponseSpeed',
    'DISPID_SPRuleChildren', 'SVSFNLPSpeakPunc', 'SAFTText',
    'DISPID_SPPConfidence', 'ISpEventSource',
    'DISPID_SRCEPhraseStart', 'eLEXTYPE_PRIVATE3', 'SPRST_INACTIVE',
    'DISPID_SPPEngineConfidence', 'DISPID_SPRuleFirstElement',
    'SpeechAudioFormatType', 'DISPID_SRCEAudioLevel',
    'SpeechVisemeType', 'DISPID_SABIMinNotification',
    'SpeechCategoryAppLexicons', 'SPWF_SRENGINE', 'SVP_3',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRGDictationUnload', 'DISPID_SDKOpenKey',
    'SpeechCategoryAudioIn', 'SPPS_Unknown', 'DISPID_SOTSetId',
    'SPVISEMES', 'DISPID_SPERequiredConfidence',
    'SAFTCCITT_ALaw_8kHzMono', 'SpeechAudioFormatGUIDText',
    'DISPID_SGRsFindRule', 'SpeechTokenKeyUI', 'DISPID_SVGetVoices',
    'DISPID_SPEs_NewEnum', 'SPSFunction', 'DISPID_SOTIsUISupported',
    'SPEI_SR_RETAINEDAUDIO', 'SVP_10', 'DISPID_SVGetProfiles',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SVSCurrentStreamNumber',
    'SpeechInterference', 'DISPID_SGRSRule', 'DISPID_SDKEnumKeys',
    'SGDSActiveWithAutoPause', 'SAFT16kHz16BitStereo',
    'SPSHT_NotOverriden', 'SPSEMANTICFORMAT',
    'DISPID_SpeechRecoContextEvents', 'ISequentialStream',
    'ISpObjectWithToken', 'eLEXTYPE_PRIVATE6', 'DISPID_SVSVisemeId',
    'SPPS_RESERVED4', 'ISpeechResourceLoader', 'SPVPRI_OVER',
    'DISPID_SpeechLexicon', '_ISpeechVoiceEvents', 'SPAS_PAUSE',
    'SAFT24kHz16BitStereo', 'DISPID_SFSClose', 'SPVPRIORITY',
    'SPCONTEXTSTATE', 'DISPID_SRIsUISupported', 'SPAS_CLOSED',
    'SP_VISEME_6', 'DISPID_SAFGetWaveFormatEx',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SBSSeek',
    'DISPID_SLAddPronunciation', 'SAFTCCITT_uLaw_11kHzStereo',
    'SRESoundStart', 'ISpProperties', 'DISPID_SVEViseme',
    'DISPID_SRGIsPronounceable', 'DISPID_SGRAttributes',
    'SAFT24kHz8BitStereo', 'SGDSActive', 'SpMemoryStream',
    'SRADynamic', 'ISpRecoGrammar',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpFileStream',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRSTPropertyValue',
    'DISPID_SpeechFileStream', 'SPEI_RECO_OTHER_CONTEXT',
    'Speech_Max_Pron_Length', 'SPXRO_SML',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SDKCreateKey',
    'SPSERIALIZEDRESULT', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPISaveToMemory', 'DISPID_SVWaitUntilDone',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpeechMMSysAudio',
    'DISPID_SDKDeleteKey', 'DISPID_SpeechPhraseProperty',
    'DISPID_SPRuleId', 'SPWF_INPUT', 'SPSMF_SAPI_PROPERTIES',
    'SAFT48kHz8BitStereo', 'SPEI_PHRASE_START',
    'SAFTExtendedAudioFormat', 'SPEI_PHONEME', 'DISPID_SPCLangId',
    'SPGS_DISABLED', 'SDKLCurrentUser', 'SPEI_SENTENCE_BOUNDARY',
    'SPEI_START_SR_STREAM', 'SpMMAudioEnum', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRSTransitions', 'SPINTERFERENCE_NOISE', 'SWTAdded',
    'SPSHORTCUTTYPE', 'SASClosed', 'DISPID_SPIEngineId',
    'DISPID_SRRecognizer', 'ISpeechBaseStream', 'DISPID_SOTCDefault',
    'SRSInactive', 'DISPID_SGRClear', 'SAFT32kHz8BitMono',
    'SpeechTokenShellFolder', 'DISPID_SVSpeak', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRCResume', 'DISPID_SDKSetLongValue', 'SPPS_LMA',
    'DISPID_SPIAudioSizeTime', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SGRSTText', 'SGDisplay',
    'ISpeechLexiconWords', 'DISPID_SLPSymbolic',
    'SAFTGSM610_22kHzMono', 'SREFalseRecognition', 'SVSFVoiceMask',
    'SpeechGrammarState', 'SSTTWildcard',
    'DISPIDSPTSI_SelectionLength', 'SDA_One_Trailing_Space',
    'DISPID_SFSOpen', 'DISPID_SPEAudioStreamOffset', 'ISpPhraseAlt',
    'DISPID_SRGId', 'SP_VISEME_12', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFT22kHz16BitStereo', 'ISpRecoContext2', 'SpeechFormatType',
    'SVSFPurgeBeforeSpeak', 'SAFT8kHz16BitMono', 'SRERequestUI',
    'DISPID_SLWs_NewEnum', 'SPINTERFERENCE_TOOLOUD', 'SECFIgnoreCase',
    'SPWT_DISPLAY', 'ISpAudio', 'SREPropertyStringChange',
    'DISPID_SRCEInterference', 'SP_VISEME_17',
    'DISPID_SpeechVoiceEvent', 'eLEXTYPE_PRIVATE20',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVSFParseSsml',
    'DISPID_SGRInitialState', 'SAFTADPCM_8kHzMono',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVAlertBoundary', 'DISPID_SpeechObjectTokens',
    'SAFTGSM610_44kHzMono', 'DISPID_SGRsCommit',
    'DISPID_SpeechPhraseElement', 'DISPIDSPTSI_ActiveLength',
    'ISpRecognizer', 'SpeechRunState', 'SAFT16kHz8BitStereo',
    'SREBookmark', 'SPVPRI_ALERT', 'DISPID_SRGetRecognizers',
    'SBOPause', 'SSTTDictation', '_ISpeechRecoContextEvents',
    'SpPhraseInfoBuilder', 'SpeechCategoryRecognizers',
    'DISPID_SMSALineId', 'SVSFNLPMask', 'SPAUDIOBUFFERINFO',
    'IEnumString', 'DISPID_SVAudioOutput',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SGRs_NewEnum',
    'SDTDisplayText', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SpeechLexiconWord', 'DISPID_SLGetWords',
    'ISpeechPhraseProperties', 'SREHypothesis', 'SPBINARYGRAMMAR',
    'DISPID_SPIGetText', 'eLEXTYPE_PRIVATE8', 'eLEXTYPE_PRIVATE11',
    'SPEI_WORD_BOUNDARY', 'SVEViseme', 'ISpRecoCategory', 'SPSNoun',
    'SPCS_DISABLED', 'DISPID_SMSADeviceId', 'DISPID_SPEsCount',
    'SSSPTRelativeToEnd', 'SpeechLexiconType', 'SPPHRASEREPLACEMENT',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SOTMatchesAttributes',
    'SVP_15', 'SWPUnknownWordUnpronounceable',
    'DISPID_SpeechPhraseAlternates', 'SPPS_RESERVED3',
    'DISPID_SVSPhonemeId', 'SDTAlternates', 'SPPS_Noun',
    'SECFIgnoreKanaType', 'SPEI_RESERVED6', 'SVEAllEvents',
    'ISpeechGrammarRuleStateTransition', 'SPRST_ACTIVE',
    'DISPID_SPIReplacements', 'SpPhoneticAlphabetConverter',
    'DISPID_SpeechRecoContext', 'DISPID_SDKSetStringValue',
    'ISpeechObjectTokens', 'eLEXTYPE_APP', 'DISPID_SMSSetData',
    'SRAInterpreter', 'ISpeechPhraseProperty', '_RemotableHandle',
    'DISPID_SGRSTPropertyId', 'SPAUDIOSTATE', 'DISPID_SPRuleParent',
    'ISpStreamFormat', 'SLOStatic', 'DISPID_SpeechRecoResultTimes',
    'SAFTNonStandardFormat', 'SRAORetainAudio', 'ISpNotifySink',
    'DISPID_SPEActualConfidence', 'SpeechAudioProperties',
    'SPEI_TTS_BOOKMARK', 'SPAR_High', 'DISPID_SRCSetAdaptationData',
    'SPBOOKMARKOPTIONS', 'DISPID_SRCRecognizer', 'SPAUDIOOPTIONS',
    'DISPID_SOTCSetId', 'STSF_LocalAppData', 'SPTEXTSELECTIONINFO',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpeechPhoneConverter',
    'SpeechTokenKeyAttributes', 'DISPID_SVSpeakStream', 'SRARoot',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRCRetainedAudio',
    'DISPID_SRRGetXMLErrorInfo', 'SPPS_NotOverriden', 'SVP_12',
    'SP_VISEME_3', 'SITooQuiet', 'ISpeechObjectToken',
    'DISPID_SRSSupportedLanguages', 'SDA_No_Trailing_Space',
    'DISPID_SpeechAudioFormat', 'DISPID_SpeechAudioBufferInfo',
    'LONG_PTR', 'SVP_9', 'SPINTERFERENCE_TOOSLOW', 'SPSSuppressWord',
    'DISPID_SPRuleName', 'SGRSTTTextBuffer', 'ISpeechRecoContext',
    'SPAO_RETAIN_AUDIO', 'SVP_5', 'SVSFlagsAsync', 'SPEI_TTS_PRIVATE',
    'SGLexicalNoSpecialChars', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SPILanguageId',
    'SPBO_TIME_UNITS', 'ISpShortcut', 'DISPID_SVPriority',
    'ISpPhoneticAlphabetConverter', 'SAFTGSM610_11kHzMono',
    'DISPID_SGRSTNextState', 'SpeechRecoEvents',
    'DISPID_SVEEnginePrivate', 'SPAUDIOSTATUS', 'ISpRecoContext',
    'SpeechRecoProfileProperties', 'SpeechWordPronounceable',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPAStartElementInResult',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPAsCount', 'SGSExclusive',
    'SPBO_NONE', 'DISPID_SPERetainedStreamOffset', 'SP_VISEME_20',
    'SSSPTRelativeToCurrentPosition', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SDKGetBinaryValue', 'SpeechTokenValueCLSID',
    'DISPID_SVSInputSentenceLength', 'eLEXTYPE_PRIVATE15',
    'SPFM_CREATE', 'SPRS_ACTIVE', 'SVP_13', 'SINoSignal',
    'SSFMOpenForRead', 'ISpPhoneticAlphabetSelection', 'SPEI_MAX_SR',
    'DISPID_SVSLastResult', 'SPDATAKEYLOCATION',
    'DISPID_SpeechRecoResult2', 'DISPID_SPRNumberOfElements',
    'SPLO_STATIC', 'ISpXMLRecoResult', 'DISPID_SpeechGrammarRule',
    'SAFT8kHz8BitStereo', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPRulesCount',
    'DISPID_SLPPartOfSpeech', 'SpeechVoiceSpeakFlags',
    'SPFM_OPEN_READONLY', 'ISpeechObjectTokenCategory',
    'SAFT48kHz16BitMono', 'SPEI_RESERVED1',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPIProperties',
    'SVSFParseMask', 'SECFDefault', 'DISPID_SRGState',
    'eLEXTYPE_RESERVED10', 'SPEI_END_INPUT_STREAM',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVGetAudioInputs',
    'DISPID_SVVolume', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPWORDPRONUNCIATIONLIST', 'SGPronounciation',
    'DISPID_SPARecoResult', 'SSTTTextBuffer', 'STCInprocServer',
    'SpMMAudioOut', 'DISPID_SRAudioInputStream',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SGRAddState',
    'SpeechAudioState', 'ISpNotifySource', 'DISPID_SRSAudioStatus',
    'ISpPhrase', 'SpCompressedLexicon', 'SP_VISEME_7', 'SP_VISEME_4',
    'DISPID_SPRuleConfidence', 'SpeechUserTraining',
    'DISPID_SLWsCount', 'SP_VISEME_15', 'DISPID_SOTCId',
    'ISpeechXMLRecoResult', 'SpTextSelectionInformation',
    'ISpEventSink', 'SPSVerb', 'SP_VISEME_16', 'DISPID_SPRText',
    'DISPID_SREmulateRecognition', 'ISpeechRecoResult2',
    'Speech_StreamPos_Asap', 'eLEXTYPE_RESERVED6',
    'DISPID_SpeechPhraseProperties', 'ISpeechFileStream',
    'SPSInterjection', 'SpSharedRecognizer', 'DISPID_SOTId',
    'DISPID_SVIsUISupported', 'DISPID_SVAudioOutputStream',
    'SAFT16kHz8BitMono', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SLPsCount', 'DISPID_SASetState', 'SWTDeleted', 'SASPause',
    'SPCT_SLEEP', 'SPDKL_DefaultLocation',
    'SpeechPropertyComplexResponseSpeed', 'SpStreamFormatConverter',
    'DISPID_SPEEngineConfidence', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechSpecialTransitionType', 'DISPID_SPEDisplayText',
    'eWORDTYPE_ADDED', 'DISPID_SPPName', 'DISPIDSPTSI',
    'DISPID_SVStatus', 'DISPID_SRGCommit', 'IStream',
    'DISPID_SPEDisplayAttributes', 'SAFT44kHz8BitStereo',
    'SSFMOpenReadWrite', 'ISpeechAudioStatus', 'SP_VISEME_19',
    'SPPHRASEPROPERTY', 'DISPID_SDKEnumValues',
    'DISPID_SPPNumberOfElements', 'SREStreamEnd', 'DISPID_SGRSTRule',
    'DISPID_SLPType', 'SPPS_Noncontent', 'SRERecognition',
    'DISPID_SOTRemove', 'DISPID_SRGDictationSetState',
    'DISPID_SRCEventInterests', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SGRSTsCount', 'SWPUnknownWordPronounceable',
    'DISPID_SPIGetDisplayAttributes', 'SRAExport', 'SVSFIsNotXML',
    'SPEI_SOUND_START', 'DISPID_SAFType', 'SpeechRuleState',
    'SGRSTTWildcard', 'ISpResourceManager', 'SPDKL_CurrentUser',
    'DISPID_SPIGrammarId', 'DISPID_SWFEChannels',
    'DISPID_SpeechXMLRecoResult', 'SREAllEvents',
    'SRERecoOtherContext', 'SpeechLoadOption', 'IEnumSpObjectTokens',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SDKSetBinaryValue',
    'SDTReplacement', 'SAFTADPCM_22kHzStereo', 'SPEVENT',
    'SPPS_Function', 'DISPID_SpeechAudio', 'DISPID_SOTGetDescription',
    'SP_VISEME_5', 'DISPID_SLAddPronunciationByPhoneIds',
    'SRTStandard', 'ISpeechRecognizerStatus', 'SPINTERFERENCE',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCERecognition',
    'DISPID_SRState', 'SAFT32kHz16BitMono', 'SPAR_Unknown',
    'DISPID_SpeechWaveFormatEx', 'SpeechRecognitionType',
    'DISPID_SGRsDynamic', 'SGSEnabled', 'SPGRAMMARSTATE',
    'SFTSREngine', 'DISPID_SADefaultFormat',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFT44kHz16BitStereo',
    'SPSHT_OTHER', 'SpeechRecognizerState', 'DISPID_SRCBookmark',
    'SVEVoiceChange', 'DISPID_SVESentenceBoundary',
    'SAFT24kHz16BitMono', 'DISPID_SWFEExtraData', 'SP_VISEME_9',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SPRsItem', 'DISPID_SRGCmdSetRuleIdState', 'SP_VISEME_0',
    'SAFT44kHz16BitMono', 'SAFT48kHz16BitStereo',
    'DISPID_SRAudioInput', 'DISPID_SPAPhraseInfo',
    'DISPID_SMSAMMHandle', 'ISpeechRecoGrammar', 'DISPID_SOTDataKey',
    'SPEI_RESERVED2', 'SPSHT_EMAIL', 'SPSERIALIZEDPHRASE',
    'DISPID_SPPChildren', 'ISpeechLexiconPronunciations',
    'DISPID_SpeechObjectTokenCategory', 'SpeechRecoContextState',
    'SRSEIsSpeaking', 'SPSHORTCUTPAIRLIST', 'eLEXTYPE_PRIVATE4',
    'DISPID_SASFreeBufferSpace', 'DISPID_SLWsItem',
    'DISPID_SLPLangId', 'SP_VISEME_21', 'SPVOICESTATUS',
    'SpNotifyTranslator', 'SPEI_SR_AUDIO_LEVEL', 'SPSHORTCUTPAIR',
    'DISPID_SPPBRestorePhraseFromMemory', 'SGDSInactive',
    'DISPID_SVVoice', 'SREStreamStart', 'DISPID_SGRSTsItem',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPEAudioSizeBytes',
    'SDTPronunciation', 'DISPID_SPPsCount', 'DISPID_SPEsItem',
    'DISPID_SPIElements', 'SVSFIsFilename', 'ISpStream',
    'DISPID_SpeechRecoResult', 'SRTEmulated', 'ISpMMSysAudio',
    'SAFT11kHz16BitMono', 'eLEXTYPE_PRIVATE12', 'SP_VISEME_14',
    'SAFT12kHz16BitStereo', 'SLTApp', 'DISPID_SRRAlternates',
    'SAFTADPCM_8kHzStereo', 'DISPID_SGRsCount',
    'DISPID_SRRRecoContext', 'STSF_FlagCreate', 'DISPID_SOTsItem',
    'DISPID_SpeechPhraseRules', 'SRTSMLTimeout', 'SP_VISEME_1',
    'DISPID_SRSetPropertyString', 'DISPID_SRCState', 'SVP_6',
    'SPRECOGNIZERSTATUS', 'SDTAudio', 'SRTExtendableParse',
    'SDKLLocalMachine', 'SPDKL_CurrentConfig', 'DISPID_SWFEFormatTag',
    'DISPID_SVDisplayUI', 'SRTReSent', 'DISPID_SRCEFalseRecognition',
    'DISPID_SDKDeleteValue', 'SpeechAudioFormatGUIDWave',
    'SPEI_UNDEFINED', 'ISpDataKey', 'DISPID_SpeechPhoneConverter',
    'SVF_Stressed', 'SPGS_EXCLUSIVE', 'SPCT_SUB_COMMAND', 'SPPHRASE',
    'SGRSTTDictation', 'DISPID_SRGRecoContext', 'SPWT_LEXICAL',
    'SDTLexicalForm', 'SAFT8kHz8BitMono', 'SREStateChange',
    'DISPID_SVSLastBookmark', 'SPWORDLIST', 'SpeechCategoryVoices',
    'ISpeechRecognizer', 'SpeechVisemeFeature',
    'DISPID_SRGetPropertyNumber', 'SPRST_NUM_STATES', 'SPFILEMODE',
    'SPVPRI_NORMAL', 'DISPID_SVSInputWordLength',
    'DISPID_SRRPhraseInfo', 'DISPID_SPAsItem', 'DISPID_SRCEEndStream',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SGRSTWeight',
    'DISPID_SpeechLexiconWords', 'SpeechTokenKeyFiles', 'SRSActive',
    'DISPID_SPRulesItem', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SRCCmdMaxAlternates', 'SPGS_ENABLED',
    'DISPID_SpeechObjectToken', 'DISPID_SLGetPronunciations',
    'SpStream', 'SPEI_MIN_SR', 'SPEI_SOUND_END',
    'SPINTERFERENCE_TOOFAST', 'SPAR_Low', 'IInternetSecurityMgrSite',
    'SpeechPropertyResourceUsage', 'SPAS_RUN',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRRSaveToMemory', 'STCAll',
    'SAFT22kHz8BitStereo', 'SAFT32kHz8BitStereo', 'SVEWordBoundary',
    'eLEXTYPE_PRIVATE17', 'SVF_Emphasis', 'SVSFDefault'
]

_check_version('1.1.14', 1633527245.904738)
