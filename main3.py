...
def realizar_tarefa(comando):
    if "olá" in comando or "oi" in comando:
        ...
        falar("Ok, vou abrir o bloco de notas para você criar a sua lista de tarefas.")
    elif "definir um lembrete" in comando:
        os.system("calc.exe")
        falar("Ok, vou abrir a calculadora para você definir o seu lembrete.")
    else:
        falar("Desculpe, não entendi o seu comando. Por favor, tente novamente.")
